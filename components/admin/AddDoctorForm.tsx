...
const doctorSchema = z.object({
  ...
  exp: z.coerce.number().min(0, "Experience cannot be negative").default(0),
  fee: z.coerce.number().min(0, "Fee cannot be negative").default(0),
  advanceFee: z.coerce.number().min(0, "Advance fee cannot be negative").default(0),
  totalSeats: z.coerce.number().min(1, "At least 1 seat required").default(10),
